...
// ---------------------------------------------------------------------
// ES Module version. Same calculation logic as engine.js, only the module
// wrapper changed (UMD -> plain `export`). See pricing-config.esm.js for
// why. This file does NOT replace engine.js -- both exist side by side.
// ---------------------------------------------------------------------
...
export function calculatePrice(order, config) {
